...
const socialLinks = [
  {
    href: 'https://github.com/niteshchauhan0',
  ...
  {
    href: 'https://www.linkedin.com/in/nitesh-singh-1a6159245',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://leetcode.com/u/niteshrajputtt/',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down" viewBox="0 0 32 32">
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
         action="https://getform.io/f/bpjjzjnb"
         method="POST"
              ...
              <label
               ...
               >
                ...
                <input
                 ...
                 id="email"
                 autoComplete="email"
                 placeholder="niteshchauhan1717@gmail.com" 
                 className="text-field reveal-up"
                  />
